...
<table width="400" >
    ...
    <?php $__currentLoopData = $filteredContacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td> <?php echo isset($contact['name']) ? $contact['name'] : ''; ?> </td>
